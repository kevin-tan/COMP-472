...
all_docs, all_labels = read_documents("data/all_sentiment_shuffled.txt")
...
plot_data(train_labels + eval_labels)
...
# predict_with_classifier(MultinomialNB(), "result/nb.txt", train_X, train_labels, test_X, eval_labels)
...
# predict_with_classifier(DecisionTreeClassifier(criterion='entropy'), 'result/defaultBaseDT.txt', train_X, train_labels,
#                         test_X,
#                         eval_labels)
...
# predict_with_classifier(find_best_dt_with_params(train_X, train_labels), 'result/improvedBaseDT.txt', train_X,
#                         train_labels, test_X,
#                         eval_labels)

# Task 4: Analysis see Google Doc
